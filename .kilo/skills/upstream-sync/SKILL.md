...
8. **Check + invarianti**: `bun turbo typecheck`, `bun run lint`, `bun run script/check-workflows.ts` da root; poi verificare una per una le invarianti I1–I10 con i comandi grep della matrice in `docs/upstream-sync.md`.
