 ...
 * `workspaceFolders[0]` because the user may intend to run project-scoped
 * operations in `/repo-b`, not `/repo-a`.
 *
 ...
 *    **disable project-scope operations**. This prevents silently writing
 *    config into the wrong project.
 *
