 ...
 *
 * Local copy of packages/opencode/src/kilocode/util/url.ts so the webview does
 * not import outside its own package boundary. Keep semantics in sync manually.
 */
