...
export const dict = {
  ...
  "settings.autoApprove.tool.skill": "Load skills. Allows loading predefined skills by name.",  "settings.autoApprove.tool.todoreadwrite": "Manage task list. Allows reading and updating the internal task list.",
