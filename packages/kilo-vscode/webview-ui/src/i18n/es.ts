...
export const dict = {
  ...
  "model.group.auto": "Modelos auto",
  "model.group.recommended": "Recomendados",
  ...
  "settings.providers.section.custom": "Proveedores personalizados",
  ...
  "settings.models.hidePromptTraining.description": "Oculta los modelos cuyos proveedores pueden usar tus prompts para entrenamiento.",
  ...
  "settings.autoApprove.tool.skill": "Cargar habilidades. Permite cargar habilidades predefinidas por su nombre.",  "settings.autoApprove.tool.todoreadwrite":
