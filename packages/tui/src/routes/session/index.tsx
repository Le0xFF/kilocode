...
const sessionBindingCommands = [
  // kilocode_change - session sharing feature removed; no session.share/session.unshare bindings
  "session.rename",
  "session.timeline",
  "session.fork",
  "session.compact",
...
export function Session() {
  ...
  const sessionCommandList = createMemo(() => [
    // kilocode_change - session sharing feature removed; no Share session command item
    {
    ...
    // kilocode_change - session sharing feature removed; no Unshare session command item
    {
