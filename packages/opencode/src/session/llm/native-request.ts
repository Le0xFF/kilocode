...
import { Anthropic, OpenAI, OpenAICompatible } from "@opencode-ai/llm/providers" // kilocode_change - native gate limits the surface to openai/openai-compatible/anthropic
...
export const model = (input: Provider.Model | RequestInput, headers?: Record<string, string>) => {
  ...
  // kilocode_change start - native gate limits npm branches to the openai surface; azure/google/bedrock/openrouter removed
