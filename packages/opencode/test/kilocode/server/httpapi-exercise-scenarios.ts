...
export const kiloScenarios: Scenario[] = [
  ...
  http.protected
    ...
    .status(401),
  http.protected.get("/kilo/cloud-sessions", "kilo.cloudSessions").probe({ path: "/path" }).status(401), // kilocode_change - offline: claw routes keep-deleted; cloud-sessions route retained in the public spec surface
  http.protected
