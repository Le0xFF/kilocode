...
describe("SessionNs.getUsage", () => {
  ...
  // kilocode_change - OpenRouter usage-cost reads were removed with the online cloud surface; provider-cost
  // extraction now only covers the raw AI SDK usage escape hatch (see test/kilocode/provider-cost.test.ts).
