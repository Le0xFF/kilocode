...
export const Flag = {
  ...
  // kilocode_change - auto-update removed; no KILO_DISABLE_AUTOUPDATE / KILO_ALWAYS_NOTIFY_UPDATE flags
  ...
  // kilocode_change - LSP removed; no KILO_EXPERIMENTAL_LSP_TY flag
